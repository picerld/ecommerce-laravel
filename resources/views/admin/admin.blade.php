        ...
        <div class="container-fluid">
            ...
            <div class="container lg-12">
                ...
                <div class="card card-primary">
                    ...
                    <form method="POST" action="{{ route('produk.store') }}" enctype="multipart/form-data" class="m-3">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" placeholder="Deskripsikan produk kamu" id="floatingTextarea" name="deskripsi"></textarea>
                        </div>
                        <div class="mb-3">
